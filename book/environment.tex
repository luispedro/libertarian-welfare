...
The environment is not a topic concerning the welfare state, as the welfare
state is traditionally defined. However, not only is the traditional definition
of the welfare state very old (and, to a large extent, predating environmental
awareness) as bringing up environmental concerns is a common objection to small
government. For many, it is \emph{the} objection to smaller government.

This fact is odd. The environment is a topic in which free market advocates
...
will let the Spanish people comment on that aspect. There was, however, also
the idea that hunting elephants (an endangered species) was an environmental
crime. This was what was behind WWF's decision to ``fire'' the King as Honorary
President.
...
Economics in \FIXME{to }. According to standard economics, these mechanisms
should not work very well; and yet they do. Unfortunately, these work better in
small communities than in a large society and are easier to describe than to
engineer.}
