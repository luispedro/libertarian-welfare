...
The welfare state is one of the 20th century's achievements. I've come to
praise it, not bury to it. A modern society should catch everyone who falls
into its safety net.

In practice, however, the current welfare state suffers from the vices of 20th
century thinking. It is too trusting of bureacracies as it assumes that there
is a direct link between the goals of a bureacratic machine and the outcomes.
It mistrusts the very individuals it is trying to help. We need a \emph{better
welfare state}.
