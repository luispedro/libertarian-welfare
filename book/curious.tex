...
The curious asymmetry is two fold: many of the arguments that are seen as valid
against the very concept of economic rights lose force when applied to other
rights; and to argue that the government interferes too much does not, in the
very least, imply that we want to have anarchy.
