...
its benefits are not spread widely. The education system that a child of the
inner city or a poor rural one is forced to go through is very different from
the the one that helps the children of the educated and affluent.

This may sound like bleeding-heart liberalism, which will be followed by a
paean to public schooling. It is not, it is bleeding-heart libertarianism,
which is followed by a paean to free-market schooling (public or private).

Public schooling, as it is organized in most of the United States, does not
live up to its ideals. Nor is the problem simply lack of funding (if it were,
it would have been fixed long ago, as more is spent per pupil now than
before).\FIXME{reference for this spending claim}
...
highly-educated lower earning professionals). In fact, framing the issue as
public vs.\ private (be it profit or non-profit private) is missing the point
of many of the reforms I discuss below.
...
cautionary tale tells us to look to both sides when cross the street. It does
not tell us to never cross the street at all.
...
much to the parents who just want a babysitter. Unfortunately, they exist;
fortunately, they are in the minority.} Children have a right to education and
it should be provided with taxpayer resources.
...
The most discussed alternative to the current system is a voucher-based
mechanism. In a voucher system, parents can choose which school to send their
kids to and the schools receive funding proportional to the number of students
they attract. At the opposite end of the spectrum, we have the assigned-school
system where children attend a school that is assigned to them by the state.
This assignment is normally based on their home address, but sometimes other
factors too.

Currently in the United States, because schooling is a local rather than a
federal issue, there is no single school system and there are almost pure
voucher systems and almost pure assigned-school systems, but most places are
somewhere in between. Within the public school system, parents often have some
choices. It would also be possible to have complete school choice with only
public schools.
...
A 2013 article in the New York Times quoted a mother whose children were a
private school thanks to state help as saying ``When I tell [other parents]
about private school, they say they say I'm crazy. They think that's only for
rich people.''\backnote{With Vouchers, States Shift Aid for Schools to Families
in New York Times, March 27, 2013.
\url{http://www.nytimes.com/2013/03/28/education/states-shifting-aid-for-schools-to-the-families.html}}.
With vouchers, what used to be only for rich people can be for everybody.


I also agree with critics that say that ``school choice is not a panacea.''
But, who ever said it was, or that it had to solve all problems to be a good
idea? It just has to be better than the alternatives. I could just as easily
argue that ``assigned-schooling has not solved all problems,'' because it has
not.
